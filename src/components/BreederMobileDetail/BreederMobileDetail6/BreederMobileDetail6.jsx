...
import * as S from './BreederMobileDetail6.style';

export default function BreederMobileDetail6() {
  return (
    <S.Container>
      <S.Title>자주 물어보는 질문</S.Title>
      <S.QnALayout>
        <S.QnAContainer>
          <S.QnATitle>
        ...
        <S.QnAContainer>
          <S.QnATitle>Q. 부모 동물의 혈통서를 볼 수 있을까요?</S.QnATitle>
          <S.QnAContent>
