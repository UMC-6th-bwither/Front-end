        ...
        {activeButton === '답변' ? (
          <>
            <A.CommuBox>
              ...
              <A.CommuText1>
                입양 그렇게 어렵지 않습니다! 저희 상담 절차만 따라와주시면 큰
                어려움 없이 착한 아이들 만나실 수 있습니다.
              </A.CommuText1>
              <A.CommuText2>
                입양 절차가 어렵다고 들었는데 괜찮을까요?
              </A.CommuText2>
              <A.CommuFooterBox>
                <A.CommuNumBox>
                  <svg
                ...
                <A.CommuDate>2024.05.14</A.CommuDate>
              </A.CommuFooterBox>
            </A.CommuBox>
            <A.CommuBox>
              <A.CommuCategory>질문/고민</A.CommuCategory>
          ...
          <>
            <A.CommuPostBox>
              <A.CommuPostText>견주만 휴가를 가나요, 반려견도</A.CommuPostText>
            </A.CommuPostBox>
            <A.CommuPostFooter>
              <A.CommuPostImage src="image-url.jpg" alt="프로필 이미지" />
              <A.CommuPostAuthor>헤피브리더</A.CommuPostAuthor>
            </A.CommuPostFooter>
          </>
        )}
      </A.InfoItem>
