  ...
  return (
    <A.Layout>
      ...
      <A.Container>
        ...
        <A.Section>
          ...
          <div>
            ...
            <A.Text>
              ...
              예약을 하게 됩니다. <br /> 예약 순번 1번은 브리더와 2주간 분양
              준비 절차를 밟게 됩니다. 분양 준비가 문제 없이 완료되어야만 분양을
              받을 수 있게 되며, 만약 분양 준비 및 분양희망자에게 문제가
              생겼다면 해당 분양 희망자는 분양을 받을 수 없게 되고 다음 예약
              순번에게 분양 기회가 돌아갑니다. 다음 예약 순번도 마찬가지로
              브리더와 2주간 분양 준비 절차를 밟고 문제가 없을 시 분양을 받을 수
              있게 됩니다.
            </A.Text>
          </div>
          <div>
        ...
        <A.AdoptionSection>
          <A.AdoptionBox>
            분양 대기 동물 탭에서 분양을 희망하는 동물을 클릭하여 해당
            브리더에게 분양 희망 의사를 나타냅니다.
          </A.AdoptionBox>
          ...
          <A.DownMark src={downMark} />
          <A.AdoptionBox>
            분양 후 브리더에게 1년간 교육 및 지원을 받습니다. 브리더에게
            모니터링 정보를 넘겨주어야 합니다. <br /> (사진, 병원 검진 내역 등)
          </A.AdoptionBox>
        </A.AdoptionSection>
        <A.EndWrapper>
          <A.EndTitle>
